...
const bodyStyles = {
  background:
    "-webkit-gradient(linear, left top, right top, color-stop(0%, transparent), color-stop(50%,red), color-stop(100%,transparent))",
  background:
    "-webkit-linear-gradient(left, transparent 0%,red 50%,transparent 100%)" /* Chrome10+, Safari5.1+ */,
  background:
    "-moz-linear-gradient(left, transparent 0%,red 50%,transparent 100%)" /* FF3.6+ */,
...
class Card extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      bio:
        "Sick of doctors telling me what I couldn't do. I was a marine. A warrior... of the uh... Jarhead Clan. My cup is empty.",
      direction: "forwards"
    };
  }
  componentWillMount() {
    if (this.props.type == "wick") {
      ...
      this.setState({
        ...
        subTitle: "@HitGirl",
        bio:
          "I can't see through walls but I can kick your ass. I think some tasers look gay. Robin wishes he was me."
      });
    }
  }
  render() {
